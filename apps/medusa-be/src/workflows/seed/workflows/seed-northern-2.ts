...
const seedNorthern2WorkflowId = "seed-northern-2-workflow"

/** Northern product record v2 - transformed from Excel with dimensions */
...
export type SeedNorthern2WorkflowInput = {
...
const seedNorthern2Workflow = createWorkflow(
  seedNorthern2WorkflowId,
  (input: SeedNorthern2WorkflowInput) => {
    ...
    // create products using v2 step with dimensions support
    const createProductsStepInput: Steps.CreateProductsV2StepInput = transform(
      {
        input,
      },
    ...
    const createProductsStepResult = Steps.createProductsV2Step(
    ...
    return new WorkflowResponse({
      ...
      result: "Northern seed v2 done",
    })
  }
)

export default seedNorthern2Workflow
