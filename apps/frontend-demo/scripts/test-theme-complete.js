...
async function testThemeComplete() {
  ...
  console.log(
    `✓ Clean start: ${!state.localStorage && state.htmlClasses.includes('light') && !state.switchChecked ? '✅' : '❌'}`
  )
  ...
  console.log('Result:', state)
  console.log(
    `✓ Dark mode active: ${state.htmlClasses.includes('dark') && state.localStorage === 'dark' && state.switchChecked ? '✅' : '❌'}`
  )
  ...
  console.log('Result:', state)
  console.log(
    `✓ Dark mode persisted: ${state.htmlClasses.includes('dark') && state.localStorage === 'dark' && state.switchChecked ? '✅' : '❌'}`
  )
  ...
  console.log('Result:', state)
  console.log(
    `✓ Light mode active: ${state.htmlClasses.includes('light') && state.localStorage === 'light' && !state.switchChecked ? '✅' : '❌'}`
  )
  ...
  console.log('Result:', state)
  console.log(
    `✓ Light mode persisted: ${state.htmlClasses.includes('light') && state.localStorage === 'light' && !state.switchChecked ? '✅' : '❌'}`
  )
  ...
  console.log(
    `✓ State consistent: ${state.htmlClasses.includes('dark') === state.switchChecked ? '✅' : '❌'}`
  )
