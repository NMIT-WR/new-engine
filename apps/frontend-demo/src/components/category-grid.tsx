...
export function CategoryGrid({
  ...
  return (
    <section className="bg-category-section-bg py-category-section-y">
      <div className="mx-auto max-w-category-max-w px-category-container-x flex flex-col gap-category-container-gap">
          ...
          {categories.map((category) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-category-card-padding">
                <h3 className="font-semibold text-category-item-title-size text-category-item-text">{category.name}</h3>
                <p className="text-category-item-count-size text-category-item-count">{category.count} items</p>
              </div>
            </Link>
          ))}
        </div>
