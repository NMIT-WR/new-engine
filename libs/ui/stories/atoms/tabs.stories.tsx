...
const baseItems = [
  {
    ...
    content: (
      <div>
        <h3 className="text-lg font-semibold mb-2">Tab One Content</h3>
        <p>
  ...
  },
  {
    ...
    content: (
      <div>
        <h3 className="text-lg font-semibold mb-2">Tab Two Content</h3>
        <p>
  ...
  },
  {
    ...
    content: (
      <div>
        <h3 className="text-lg font-semibold mb-2">Tab Three Content</h3>
...
export const Variants: Story = {
  render: () => (
    <VariantContainer orientation="vertical">
      <div className="w-[600px]">
        <h3 className="text-md font-semibold mb-2">Default</h3>
        <Tabs items={baseItems} variant="default" />
      </div>
      <div className="w-[600px]">
        <h3 className="text-md font-semibold mb-2">Solid</h3>
        <Tabs items={baseItems} variant="solid" />
      </div>
      <div className="w-[600px]">
        <h3 className="text-md font-semibold mb-2">Line</h3>
...
export const Sizes: Story = {
  render: () => (
    <VariantContainer orientation="vertical">
      <div className="w-[600px]">
        <h3 className="text-md font-semibold mb-2">Small</h3>
        <Tabs items={baseItems} size="sm" />
      </div>
      <div className="w-[600px]">
        <h3 className="text-md font-semibold mb-2">Medium (Default)</h3>
        <Tabs items={baseItems} size="md" />
      </div>
      <div className="w-[600px]">
        <h3 className="text-md font-semibold mb-2">Large</h3>
