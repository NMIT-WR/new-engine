  ...
  render: () => (
    <VariantContainer>
      ...
      <VariantGroup title="Light themes">
        ...
        <Button variant="warning" theme="light">Warning Light</Button>
        <Button variant="danger" theme="light">Danger Light</Button>
      </VariantGroup>
      <VariantGroup title="Outlined themes">
        <Button variant="primary" theme="outlined">Primary Outlined</Button>
        <Button variant="secondary" theme="outlined">Secondary Outlined</Button>
        <Button variant="tertiary" theme="outlined">Tertiary Outlined</Button>
        <Button variant="warning" theme="outlined">Warning Outlined</Button>
        <Button variant="danger" theme="outlined">Danger Outlined</Button>
      </VariantGroup>
      <VariantGroup title="Borderless themes">
        <Button variant="primary" theme="borderless">Primary Borderless</Button>
        <Button variant="secondary" theme="borderless">Secondary Borderless</Button>
        <Button variant="tertiary" theme="borderless">Tertiary Borderless</Button>
        <Button variant="warning" theme="borderless">Warning Borderless</Button>
        <Button variant="danger" theme="borderless">Danger Borderless</Button>
      </VariantGroup>
    </VariantContainer>
  ),
};
    ...
    return (
      <VariantContainer>
        ...
        <VariantGroup title="Loading states">
          ...
          <Button isLoading theme="outlined" loadingText="Loading...">Outlined</Button>
    ...
    render: () => (
      <VariantContainer>
        ...
        <VariantGroup title="Warning buttons">
          ...
          <Button variant="warning" size="md">DEFAULT</Button>
        ...
        <VariantGroup title="Danger buttons">
          ...
          <Button variant="danger" size="md">DEFAULT</Button>
    ...
    render: () => (
      <VariantContainer>
        <VariantGroup title="Icon buttons">
          ...
          <Button icon="icon-[mdi--send]" iconPosition="right">SEND</Button>
          <Button icon="icon-[mdi--magnify]" aria-label="Search" />
          <Button variant="secondary" icon="icon-[mdi--pencil]">EDIT</Button>
          <Button variant="danger" icon="icon-[mdi--delete]">DELETE</Button>
        </VariantGroup>
      </VariantContainer>
    ),
  };
