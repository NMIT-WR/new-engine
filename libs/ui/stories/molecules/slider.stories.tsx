...
export const Default: Story = {
  ...
  render: (args) => (
    <div className="min-w-container-sm">
      <Slider {...args} />
    </div>
  ),
}
...
export const VerticalOrientation: Story = {
  ...
  render: () => {
    ...
    return (
      <VariantContainer>
        <div className="grid h-container-3xs w-10/12 grid-cols-3 gap-600">
          <Slider
            {...baseSliderProps}
            id="vertical-sm"
...
export const SingleVsMultiThumb: Story = {
  render: () => (
    <VariantContainer>
      <div className="grid w-full min-w-container-xs gap-600">
        <Slider
          {...baseSliderProps}
          id="single-thumb"
  ...
  render: () => (
    <VariantContainer>
      <VariantGroup title="Sizes">
        <div className="w-full min-w-container-3xs">
          <Slider
            {...baseSliderProps}
            size="sm"
            label="Small"
