...
const stepsVariants = tv({
  slots: {
    ...
    indicator: [
      ...
      "group-focus-visible:outline-(style:--default-ring-style) group-focus-visible:outline-(length:--default-ring-width)",
      "group-focus-visible:outline-steps-ring",
      "group-focus-visible:outline-offset-(length:--default-ring-offset)",
      ...
      "focus-visible:data-[current]:outline-(style:--default-ring-style) focus-visible:data-[current]:outline-(length:--default-ring-width)",
      "focus-visible:data-[current]:outline-steps-ring",
      "focus-visible:data-[current]:outline-offset-(length:--default-ring-offset)",
