...
const stepsVariants = tv({
  slots: {
    ...
    indicator: [
      ...
      "group-focus-visible:outline-(length:--default-ring-width)",
      ...
      "focus-visible:data-[current]:outline",
      "focus-visible:data-[current]:outline-(length:--default-ring-width)",
      "focus-visible:data-[current]:outline-steps-ring",
      "focus-visible:data-[current]:outline-offset-2",
