...
const numericInputVariants = tv({
  slots: {
    root: ['flex relative'],
    container: [
      'flex relative border-(length:--border-width-numeric-input)',
    ...
    input: [
      'p-numeric-input-input',
      'bg-numeric-input-input-bg border-none focus:bg-numeric-input-input-bg-active hover:bg-numeric-input-input-bg-hover',
