...
| Task | Guide | When |
|------|-------|------|
| Component (.tsx) | [components.md](./instructions/components.md) | Always for new components |
| Tokens (.css) | [tokens.md](./instructions/tokens.md) | When creating/modifying tokens |
| Story (.stories.tsx) | [storybook.md](./instructions/storybook.md) | Always for new stories |
...
For Zag.js components, consult official documentation first:
- **Context7 MCP** (if available) — query Zag.js docs directly
- **Fallback** — visit [zagjs.com](https://zagjs.com) manually

For Tailwind v4 or tailwind-variants questions:
- **Web search** or [tailwindcss.com](https://tailwindcss.com)
